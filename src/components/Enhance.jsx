...
const FileUpload = () => {
  ...
  const uploadFile = async () => {
    ...
    try {
      ...
      setProcessedImage(`{https://localhost:8000${response.data.processed_image_url}`);
  ...
  return (
    <div className="min-h-screen flex flex-col items-start   bg-stone-400 w-full p-6 " id="Enhance">
        <h2 className="text-center text-4xl text-black mb-30 mx-auto">Enhance</h2>
        <p className="text-start  text-2xl text-black mb-4 ml-40 ">Choose the Image you want to De-Noise</p>
